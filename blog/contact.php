                  ...
                  <div class="content">
                    <form id="contact" action="" method="post">
                      <div class="row">
                        ...
                        <div class="col-lg-12">
                          <fieldset>
                            <button type="submit" id="form-submit" name="feedback" class="main-button">Send
                              Message</button>
                          </fieldset>
                        </div>
                      </div>
          ...
          <div id="map" >
            ...
            <div class="mapouter">
              <div class="gmap_canvas"><iframe width="1000" height="500" id="gmap_canvas"
                  src="https://maps.google.com/maps?q=bangladesh,khilgaon,taltola&t=&z=11&ie=UTF8&iwloc=&output=embed"
